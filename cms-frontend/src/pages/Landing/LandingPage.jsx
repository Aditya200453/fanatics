import { Container, Nav, Navbar, Button, Row, Col, Card, Modal, Dropdown } from "react-bootstrap";
import "./Landing.css";
    ...
    <div className="lp">
        ...
        <Container fluid className="px-4">
          ...
          <Navbar.Collapse id="lp-nav">
            ...
            <Nav className="ms-auto align-items-center gap-2">
              ...
              <Button className="lp-pill" variant="outline-info">
                Whatsapp
              </Button>
          ...
          <Row className="align-items-center">
            <Col lg={8}>
              ...
              <p className="lp-subtitle">
                Manage appointments, patient history, consultations and diagnostics in one role‑based platform.
              </p>
              ...
              <div className="d-flex flex-wrap gap-2 mt-4">
                {["Role-based access", "Centralized records", "Faster appointments", "Diagnostics tracking"].map((t) => (
      ...
      <section id="services" className="lp-section">
        <Container>
          ...
          <Row className="g-4">
            {[
              { icon: "bi-calendar2-check", title: "Appointment Booking", desc: "Book appointments by specialty and doctor." },
              { icon: "bi-folder2-open", title: "Patient Records", desc: "Consistent patient history & visit timeline." },
              { icon: "bi-prescription2", title: "Prescriptions", desc: "Store prescriptions and fetch anytime." },
              { icon: "bi-file-earmark-medical", title: "Diagnostics", desc: "Assign tests and maintain results." },
            ].map((x) => (
              <Col md={6} lg={3} key={x.title}>
                <Card className="lp-feature-card h-100 border-0">
                  <Card.Body className="p-4">
                    ...
                    <Card.Title className="mt-3 fw-bold text-center">{x.title}</Card.Title>
                    <Card.Text className="text-muted text-center mb-0">{x.desc}</Card.Text>
                  </Card.Body>
                </Card>
              </Col>
            ))}
      ...
      <footer id="contact" className="lp-footer">
        <Container className="py-4 d-flex flex-column flex-md-row justify-content-between gap-2">
          <div className="text-white-50">© {new Date().getFullYear()} ClinicCare</div>
